      ...
      <div className="text-center w-full py-16 sm:py-0">
        <div className="sm:py-14 min-h-[calc(100vh-19rem)] sm:min-h-[calc(100vh-15rem)] flex flex-col justify-center items-center">
          {submitted ? (
            ...
            <>
              <p className="font-fairplex small-caps tracking-wider font-black text-xl uppercase pb-4">
              ...
              >
                ...
                <label
                  htmlFor="dietary"
                  className="lowercase block text-sm my-1 pt-4"
                >
                  Any dietary needs?
                </label>
                <textarea
                ...
                <button
                  type="submit"
                  className="self-center flex items-center mt-3 gap-2 lowercase rounded-full text-slate-100 px-6 py-1 text-base bg-cobalt-500 w-fit select-none"
                >
